...
from aitrade.constants import USERPATH_STRATEGIES
from aitrade.enums import RunMode
from aitrade.exceptions import OperationalException
from aitrade.exchange import market_is_active, validate_exchanges
from aitrade.misc import parse_db_uri_for_logging, plural
...
def start_show_trades(args: Dict[str, Any]) -> None:
    ...
    from aitrade.persistence import Trade, init_db
    config = setup_utils_configuration(args, RunMode.UTIL_NO_EXCHANGE)
