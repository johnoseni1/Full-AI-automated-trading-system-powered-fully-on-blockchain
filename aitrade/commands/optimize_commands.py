...
from aitrade.configuration import setup_utils_configuration
from aitrade.enums import RunMode
from aitrade.exceptions import OperationalException
from aitrade.misc import round_coin_value
...
def start_backtesting_show(args: Dict[str, Any]) -> None:
    ...
    from aitrade.data.btanalysis import load_backtest_stats
    from aitrade.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_edge(args: Dict[str, Any]) -> None:
    ...
    :return: None
    """
    from aitrade.optimize.edge_cli import EdgeCli
