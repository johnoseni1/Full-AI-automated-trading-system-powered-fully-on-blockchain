...
from aitrade.rpc.api_server.uvicorn_threaded import UvicornServer
from aitrade.rpc.rpc import RPC, RPCException, RPCHandler
...
class ApiServer(RPCHandler):
    ...
    def configure_app(self, app: FastAPI, config):
        from aitrade.rpc.api_server.api_auth import http_basic_or_jwt_token, router_login
        from aitrade.rpc.api_server.api_backtest import router as api_backtest
        from aitrade.rpc.api_server.api_v1 import router as api_v1
        from aitrade.rpc.api_server.api_v1 import router_public as api_v1_public
        from aitrade.rpc.api_server.web_ui import router_ui
