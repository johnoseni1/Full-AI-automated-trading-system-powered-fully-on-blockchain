...
from aitrade.commands import (start_backtesting_show, start_convert_data, start_convert_trades,
...
from aitrade.commands.deploy_commands import (clean_ui_subdir, download_and_install_ui,
